...
<Steps>
  ...
  <Step title="Add channels as you need them">
    ...
    - **Signal** — register a phone with `signal-cli`, add `signal_phone_number` via Settings → Channels → Signal, and recreate. See [installation §Signal messaging](/get-started/installation#signal-messaging).
