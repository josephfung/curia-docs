...
<Steps>
  ...
  <Step title="Add channels as you need them">
    ...
    - **Email** — set `NYLAS_API_KEY`, `NYLAS_GRANT_ID`, `NYLAS_SELF_EMAIL` in `.env` and recreate the container. See [installation §Email](/get-started/installation#email-nylas).
    - **Signal** — register a phone with `signal-cli`, set `SIGNAL_PHONE_NUMBER`, and recreate. See [installation §Signal messaging](/get-started/installation#signal-messaging).
