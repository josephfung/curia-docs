...
<Steps>
  ...
  <Step title="Start Curia">
    ...
    On first run this applies all database migrations, then starts the full stack. The production Docker image runs as a non-root `curia` user for security hardening.
  </Step>
  <Step title="Verify">
