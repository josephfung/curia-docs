...
The autonomy engine uses these values to determine whether a given skill can run at the current autonomy score. See [Autonomy engine](/concepts/autonomy) for the full picture.
...
<CardGroup cols={2}>
  <Card title="Adding skills" icon="wrench" href="/guides/adding-skills">
