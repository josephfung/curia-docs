...
<Note>
  This endpoint uses SSE, not WebSockets. The connection is one-directional — the server pushes events to you. To send a message, use [POST /api/messages](/api/messages) as usual, then watch events arrive on the stream.
</Note>
