...
A skill or channel can declare credentials it cannot run without. The registry refuses to install or enable it until those secrets are present in the [vault](/get-started/secrets-vault):
...
<CardGroup cols={2}>
  ...
  <Card title="How skills work" icon="puzzle-piece" href="/skills/how-skills-work">
