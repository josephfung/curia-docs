...
- **Minor** (`0.X.0`) — new tools, skills, agents, channels, or brand-new capabilities
- **1.0.0** — reserved for when the public API surfaces (tool manifests, agent YAML schema, bus event types, channel adapter interface) are stable enough to commit to
