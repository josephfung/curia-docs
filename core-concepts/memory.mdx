...
<Info>
  If `web_app_bootstrap_secret` is not configured, the knowledge-graph API is intentionally disabled. Seed it (`WEB_APP_BOOTSTRAP_SECRET=... pnpm run seed-vault`) and recreate the Curia container to enable it.
</Info>
