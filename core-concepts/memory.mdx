...
Open [http://localhost:3000](http://localhost:3000) in your browser. You'll be prompted for your `WEB_APP_BOOTSTRAP_SECRET` — the value you set in `.env` when you configured Curia. After authenticating, the knowledge graph browser is available at `/kg`.
