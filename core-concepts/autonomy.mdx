...
A daily digest at 8 AM brings everything needing your attention into one place: outstanding approval requests, plus any tasks that have stalled, hit a limit, or are blocked on you (see [Tasks and the backlog](/core-concepts/scheduling#tasks-and-the-backlog)). Nothing lingers without your awareness. See [Approval workflow](/security/approval-workflow) for the full picture.
