...
Secret values are never written to the audit log. The log tells you that the email-parser skill accessed the Nylas credential — not what that credential is.
