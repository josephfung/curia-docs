...
See [Approval workflow](/security/approval-workflow) for the full picture — how requests are created, how to approve or deny them, and how the lifecycle (expiry, daily digest) works.
