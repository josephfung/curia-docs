...
<CardGroup cols={2}>
  <Card title="POST /api/messages" icon="paper-plane" href="/api/messages">
  ...
  <Card title="GET /api/messages/stream" icon="signal" href="/api/stream">
    Open a Server-Sent Events connection to receive agent responses, tool invocations, and tool results in real time.
  </Card>
  <Card title="GET /api/health" icon="heart-pulse" href="/api/health">
