...
<AccordionGroup>
  ...
  <Accordion title="Action trust thresholds">
    ...
    These thresholds are compiled into the coordinator's system prompt at startup. Changes take effect on restart. See [Contacts and trust](/core-concepts/contacts-trust#action-thresholds) for how scores are computed.
