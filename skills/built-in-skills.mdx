...
Curia ships with 50+ skills organized into functional categories. Every skill declares an `action_risk` level that determines the minimum [autonomy score](/core-concepts/autonomy) required to invoke it without explicit CEO approval.
...
| Skill | action_risk | Description |
|---|---|---|
| `memory-store` | low | Store a fact in the knowledge graph |
...
| Skill | action_risk | Description |
|---|---|---|
| `get-autonomy` | none | Read the current autonomy score and history |
